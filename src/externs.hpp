...
extern "C" int _initialize_coords(int *coords, int nrows, int *p_pixel_dist,
                                  int D, void **metadata) {
...
int t_initialize_coords_with_duplicates(const Itype *coords, Itype nrows,
                                        ...
                                        void **metadata);
extern "C" int _initialize_coords_with_duplicates(int *coords, int nrows,
...
extern "C" int _initialize_out_coords(int *p_pixel_dist, int *p_stride,
...
int t_initialize_origin_coords(const Itype *p_pixel_dist, Itype batch_size,
                               void **metadata);
extern "C" int _initialize_origin_coords(int *p_pixel_dist, int batch_size,
                                         int D, void **metadata) {
...
int t_get_index_map(const Itype *coords, Itype nrows, Itype *p_index_map,
                    ...
                    void **metadata);
extern "C" int _get_index_map(int *coords, int nrows, int *p_index_map,
...
template <uint8_t D, typename Itype>
int t_get_num_coords(const Itype *p_pixel_dist, Itype *nrows, void **metadata);
extern "C" int _get_num_coords(int *p_pixel_dist, int *p_nrows, int D,
                               void **metadata) {
...
template <uint8_t D, typename Itype>
int t_get_coords(Itype *coords, const Itype *p_pixel_dist, void **metadata);
extern "C" int _get_coords(int *coords, int *p_pixel_dist, int D,
                           void **metadata) {
...
extern "C" int _get_permutation(int *p_permutation, int *p_pixel_dist_src,
...
int t_conv_fw(const Dtype *p_in_feat, Itype in_nchannel, Dtype *p_out_feat,
              ...
              void **metadata);
extern "C" int _conv_fw(float *p_in_feat, int in_nchannel, float *p_out_feat,
...
int t_conv_tr_fw(const Dtype *p_in_feat, Itype in_nchannel, Dtype *p_out_feat,
                 ...
                 Itype region_type, const Itype *p_offset, Itype n_offset,
                 void **metadata);
extern "C" int _conv_tr_fw(float *p_in_feat, int in_nchannel, float *p_out_feat,
                           int out_nchannel, float *p_kernel, int out_nrows,
                           int *p_pixel_dist, int *p_stride, int *p_kernel_size,
                           int *p_dilation, int region_type, int *p_offset,
                           int n_offset, int D, void **metadata) {
...
int t_conv_bw(const Dtype *p_in_feat, Dtype *p_grad_in_feat, Itype in_nchannel,
              ...
              const Itype *p_kernel_size, const Itype *p_dilation,
              void **metadata);
extern "C" int _conv_bw(float *p_in_feat, float *p_grad_in_feat,
...
int t_conv_tr_bw(const Dtype *p_in_feat, Dtype *p_grad_in_feat,
                 ...
                 const Itype *p_kernel_size, const Itype *p_dilation,
                 void **metadata);
extern "C" int _conv_tr_bw(float *p_in_feat, float *p_grad_in_feat,
                           int in_nchannel, float *p_grad_out_feat,
...
extern "C" int _conv_fw_gpu(float *d_in_feat, int in_nchannel,
...
int t_conv_tr_fw_gpu(const Dtype *d_in_feat, Itype in_nchannel,
                     ...
                     Itype region_type, const Itype *p_offset, Itype n_offset,
                     cudaStream_t stream, void **metadata);
extern "C" int _conv_tr_fw_gpu(float *d_in_feat, int in_nchannel,
                               float *d_out_feat, int out_nchannel,
...
int t_conv_bw_gpu(const Dtype *d_in_feat, Dtype *d_grad_in_feat,
                  ...
                  const Itype *p_kernel_size, const Itype *p_dilation,
                  cudaStream_t stream, void **metadata);
extern "C" int _conv_bw_gpu(float *d_in_feat, float *d_grad_in_feat,
...
int t_conv_tr_bw_gpu(const Dtype *d_in_feat, Dtype *d_grad_in_feat,
                     ...
                     const Itype *p_kernel_size, const Itype *p_dilation,
                     cudaStream_t stream, void **metadata);
extern "C" int _conv_tr_bw_gpu(float *d_in_feat, float *d_grad_in_feat,
                               int in_nchannel, float *d_grad_out_feat,
                               int out_nchannel, float *d_kernel,
                               float *d_grad_kernel, int out_nrows,
                               int *p_pixel_dist, int *p_stride,
...
int t_max_pooling_fw(const Dtype *p_in_feat, Dtype *p_out_feat,
                     ...
                     Itype region_type, const Itype *p_offset, Itype n_offset,
                     void **metadata);
extern "C" int _max_pooling_fw(float *p_in_feat, float *p_out_feat,
...
int t_max_pooling_bw(Dtype *p_grad_in_feat, Itype in_nrows,
                     ...
                     const Itype *p_kernel_size, const Itype *p_dilation,
                     void **metadata);
extern "C" int _max_pooling_bw(float *p_grad_in_feat, int in_nrows,
...
int t_max_pooling_bw_gpu(Dtype *d_grad_in_feat, Itype in_nrows,
                         ...
                         const Itype *p_kernel_size, const Itype *p_dilation,
                         cudaStream_t stream, void **metadata);
extern "C" int _max_pooling_bw_gpu(float *d_grad_in_feat, int in_nrows,
...
int t_nonzero_avg_pooling_fw(const Dtype *p_in_feat, Dtype *p_out_feat,
                             ...
                             void **metadata);
extern "C" int _nonzero_avg_pooling_fw(float *p_in_feat, float *p_out_feat,
...
extern "C" int _nonzero_avg_pooling_bw(float *p_grad_in_feat, int in_nrows,
                                       float *p_grad_out_feat, int out_nrows,
                                       int *p_num_nonzero, int nchannel,
                                       int *p_pixel_dist, int *p_stride,
                                       int *p_kernel_size, int *p_dilation,
...
int t_nonzero_avg_pooling_bw_gpu(Dtype *d_grad_in_feat, Itype in_nrows,
                                 ...
                                 void **metadata);
extern "C" int _nonzero_avg_pooling_bw_gpu(float *d_grad_in_feat, int in_nrows,
                                           float *d_grad_out_feat,
                                           int out_nrows, int *d_num_nonzero,
                                           int nchannel, int *p_pixel_dist,
                                           int *p_stride, int *p_kernel_size,
                                           int *p_dilation, cudaStream_t stream,
                                           int D, void **metadata) {
...
int t_global_avg_pooling_fw(const Dtype *p_in_feat, Dtype *p_out_feat,
                            ...
                            void **metadata);
extern "C" int _global_avg_pooling_fw(float *p_in_feat, float *p_out_feat,
...
int t_global_avg_pooling_bw(Dtype *p_grad_in_feat, Itype in_nrows,
                            ...
                            const Itype *p_pixel_dist, void **metadata);
extern "C" int _global_avg_pooling_bw(float *p_grad_in_feat, int in_nrows,
                                      float *p_grad_out_feat, int out_nrows,
...
int t_global_avg_pooling_fw_gpu(const Dtype *d_in_feat, Dtype *d_out_feat,
                                ...
                                cudaStream_t stream, void **metadata);
extern "C" int _global_avg_pooling_fw_gpu(float *d_in_feat, float *d_out_feat,
                                          int out_nrows, int nchannel,
...
int t_global_avg_pooling_bw_gpu(Dtype *d_grad_in_feat, Itype in_nrows,
                                ...
                                void **metadata);
extern "C" int _global_avg_pooling_bw_gpu(float *d_grad_in_feat, int in_nrows,
                                          float *d_grad_out_feat, int out_nrows,
