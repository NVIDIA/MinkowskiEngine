...
extern long _max_pooling_bw_gpu(float *d_grad_in_feat, int in_nrows,
...
extern long _global_broadcast_fw(float *p_in_feat, int in_nrows,
                                 float *p_in_feat_global, int in_nrows_global,
                                 float *p_out_feat, int nchannel,
                                 int *p_pixel_dist, int op, int D,
                                 void **metadata);

extern long _global_broadcast_bw(float *p_in_feat, float *p_grad_in_feat,
                                 int in_nrows, float *p_in_feat_global,
                                 float *p_grad_in_feat_global,
                                 int in_nrows_global, float *p_grad_out_feat,
                                 int nchannel, int *p_pixel_dist, int op, int D,
                                 void **metadata);

extern long _global_broadcast_fw_gpu(float *p_in_feat, int in_nrows,
