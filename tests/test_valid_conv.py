...
from SparseConvolution import SparseValidConvolution
...
if __name__ == '__main__':
    ...
    pixel_dist, stride, kernel_size, dilation, D = 1, 1, 3, 1, 2
    ...
    out = conv(in_feat)
    print(SCE.get_coords(coords2, pixel_dist * stride, D, net_metadata.ffi))
    print(SCE.get_coords_key(coords2, conv.out_coords_key, D, net_metadata.ffi))
    print(coords2)
